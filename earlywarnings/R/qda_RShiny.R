#' Description: Quick Detection Analysis for Generic Early Warning Signals in RShiny User Interface
#'
#' \code{qda_RShiny} is used in RShiny to interactively estimate autocorrelation, variance within rolling windows along a timeseries, test the significance of their trends, and reconstruct the potential landscape of the timeseries
#'
# Details:
#' see ref below
#'
...
#'
#' @examples 
#' #To try the function on the R terminal:
#' data(foldbif)
#' qda_RShiny(foldbif, param = NULL, winsize = 50, detrending="gaussian", bandwidth=NULL, boots = 100, s_level = 0.05, cutoff=0.05, detection.threshold = 0.002, grid.size = 50, logtransform=FALSE, interpolate=FALSE, analysis = "Indicator trend analysis")
#'
# ' #To run interactively on RShiny:
